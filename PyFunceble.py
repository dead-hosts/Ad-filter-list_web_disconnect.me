...
class Settings(object):  # pylint: disable=too-few-public-methods
    ...
    travis_autosave_final_commit = "[Results] Test of Ad-filter-list"
    # Default travis commit message
    travis_autosave_commit = "[Autosave] Test of Ad-filter-list"
    ...
    # Current directory.
    current_dir = '/home/travis/build/dead-hosts/Ad-filter-list_web_disconnect.me/'
